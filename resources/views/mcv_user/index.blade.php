        ...
        <main>
            ...
            <div class="premium-card">
                <div class="premium-text">
                    ...
                    <div class="button-group">
                        <a href="{{ url('purchase') }}">
                            <button><i class="fas fa-shopping-cart"></i> Account purchase</button>
                        </a>
                        <a href="{{ url('feature') }}" style="text-decoration: none;">
                            <button><i class="fas fa-bolt"></i> View features</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="stats">
                <div class="stat-box">
                    ...
                    <a href="{{ url('follower_') }}" class="info-button">See info</a>
                </div>
                ...
                <div class="stat-box">
                    ...
                    <a href="{{ url('earning_') }}" class="info-button">See info</a>
                </div>
                ...
                <div class="stat-box">
                    ...
                    <a href="{{ url('user_') }}" class="info-button">See info</a>
                </div>
            </div>
        </main>
    </div>
