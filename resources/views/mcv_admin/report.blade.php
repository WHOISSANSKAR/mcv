{{-- resources/views/mcv_admin/report.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
<body>
      ...
      <header>
        ...
        <div class="add-compliance">
          <a href="{{ url('user') }}" style="text-decoration: none;">
            <button>
              <i class="fas fa-plus-circle"></i>&nbsp;Compliance Zone
            </button>
          </a>
        </div>
      </header>
  ...
  <div class="button-input-group">
    <button class="search-btn btn-dark" onclick="window.location.href='{{ url('compliance') }}'">
      Compliance
    </button>
    ...
    <button class="add-user" onclick="window.location.href='{{ url('add-user') }}'">
      ...
      <div class="table-wrapper">
        <table id="Table" class="data-table">
          ...
          <tbody>
            {{-- Example Row (replace with @foreach loop later if dynamic) --}}
            <tr>
